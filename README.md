...
2. [图书][HTTP权威指南](http://product.dangdang.com/22840157.html)
...
16. [资料][Modern Java - A Guide to Java 8(现代Java - Java指南8)](https://github.com/winterbe/java8-tutorial)
17. [图书]Java与模式
18. [图书][Head First设计模式](http://product.dangdang.com/20021171.html)
19. [资料][Design patterns implemented in Java(Java实现的设计模式)](https://github.com/iluwatar/java-design-patterns)
...
1. [过时][资料]JavaServer Pages Specification V2.1
2. [过时][图书]JSP数据库编程指南
3. [过时][图书]JSP设计
4. [过时][图书]JSP高级编程
...
1. [资料][Tutorials for using RabbitMQ in various ways](https://github.com/rabbitmq/rabbitmq-tutorials) 以各种方式使用RabbitMQ的教程<http://www.rabbitmq.com/getstarted.html>
...
1. [资料][数据库秒级平滑扩容架构方案](https://cloud.tencent.com/developer/article/1048650)

### 缓存

1. [资料][缓存那些事](https://tech.meituan.com/cache_about.html)
### 异地多活

1. [资料][搞懂异地多活，看这篇就够了](https://mp.weixin.qq.com/s/T6mMDdtTfBuIiEowCpqu6Q)
2. [资料][四步构建异地多活](https://mp.weixin.qq.com/s/hMD-IS__4JE5_nQhYPYSTg)
...
4. [资料][gitignore][A collection of .gitignore templates](https://github.com/github/gitignore)
